...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/images_chandigarh/",
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/search/results/all/?keywords=IMAGES_CHANDIGARH&origin=RICH_QUERY_SUGGESTION&heroEntityKey=urn%3Ali%3Aorganization%3A13309826&position=1",
        ...
        <div>
          ...
          <div className="mt-5 space-y-4 text-sm text-slate-400">
            <a
              ...
              href="mailto:hello@images.community"
            >
              <Mail size={16} /> hello@images.community
            </a>
